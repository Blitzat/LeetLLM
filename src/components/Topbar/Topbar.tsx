...
const Topbar: React.FC<TopbarProps> = ({ problemPage }) => {
	...
	return (
		<nav className='relative flex h-[50px] w-full shrink-0 items-center px-5 bg-dark-layer-1 text-dark-gray-7 sticky top-0'>
			<div className={`flex w-full items-center justify-between ${!problemPage ? "max-w-[1200px] mx-auto" : ""}`}>
				...
				{problemPage && (
					<div className='flex items-center justify-center'>
						<div className='flex items-center gap-2 font-medium max-w-[170px] text-dark-gray-8 cursor-pointer'>
							<Image src='/logo.png' alt='Logo' height={100} width={100} />
						</div>
